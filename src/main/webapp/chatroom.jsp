			...
			<div class="modal-content">
				...
				<div class="chat" style="display: none" id="chat">
					<div class="chat-container">
						<div class="user-bar">
							<div class="back">
								<i class='far fa-arrow-alt-circle-left' style='font-size: 36px'
									id="back"></i>
							</div>
							<div class="avatar">
						...
						<div class="conversation dim2">
							<div class="conversation-container" id="conversation-container">
								...
								<div class="message sent">
									No I wasn't. <span class="metadata"> <span class="time"></span><span
										class="tick"><svg xmlns="http://www.w3.org/2000/svg"
												width="16" height="15" id="msg-dblcheck-ack" x="2063"
												y="2076">
												<path
								...
								<div class="message received">
									<span id="random">You were hugging an old man with a
										beard screaming "DUMBLEDORE YOU'RE ALIVE!"</span> <span
										class="metadata"><span class="time"></span></span>
								</div>
								-->
							</div>
